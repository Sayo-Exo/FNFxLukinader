...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		var pressedBack:Bool = FlxG.keys.justPressed.ESCAPE;
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			// credTextShit.screenCenter();
			case 5:
				createCoolText(['for the one', 'the only']);
			case 7:
				addMoreText('lukinader');
				ngSpr.visible = true;
			// credTextShit.text += '\nNewgrounds';
			case 8:
				deleteCoolText();
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('Lukinader'); // credTextShit.text += '\nFunkin';
