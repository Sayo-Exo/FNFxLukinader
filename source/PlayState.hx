...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'spin eternally':
				dialogue = CoolUtil.coolTextFile('assets/data/spin eternally/spinDialogue.txt');
			case 'country rounds':
				dialogue = CoolUtil.coolTextFile('assets/data/country rounds/countryDialogue.txt');
			case 'roses':
		...
		else if (SONG.song.toLowerCase() == 'senpai' || SONG.song.toLowerCase() == 'roses' || SONG.song.toLowerCase() == 'spin eternally' || SONG.song.toLowerCase() == 'country rounds')
		{
			curStage = 'school';
