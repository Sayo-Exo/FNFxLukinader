...
class StoryMenuState extends MusicBeatState
{
	...
	public static var weekUnlocked:Array<Bool> = [true, true, false, true, true, true, true];
	...
	var weekCharacters:Array<Dynamic> = [
		...
		['pico', 'bf', 'gf', 'spooky'],
		['mom', 'bf', 'gf', 'pico'],
		['parents-christmas', 'bf', 'gf', 'pico'],
		['senpai', 'bf', 'gf', 'pico']
	];

	var weekNames:Array<String> = [
		"",
		"Spin like you did in the country",
		"Spooky Month",
		"PICO",
		"MOMMY MUST MURDER",
		"RED SNOW",
