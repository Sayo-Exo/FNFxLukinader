...
class Controls extends FlxActionSet
{
	...
	var _w = new FlxActionDigital(Action.W);
	var _a = new FlxActionDigital(Action.A);
	var _d = new FlxActionDigital(Action.D);
	var _s = new FlxActionDigital(Action.S);
	var _wP = new FlxActionDigital(Action.W_P);
	var _aP = new FlxActionDigital(Action.A_P);
	var _dP = new FlxActionDigital(Action.D_P);
	var _sP = new FlxActionDigital(Action.S_P);
	var _wR = new FlxActionDigital(Action.W_R);
	var _aR = new FlxActionDigital(Action.A_R);
	var _dR = new FlxActionDigital(Action.D_R);
	var _sR = new FlxActionDigital(Action.S_R);
	...
	public var W_P(get, never):Bool;

	inline function get_W_P()
		return _wP.check();

	public var A_P(get, never):Bool;

	inline function get_A_P()
		return _aP.check();

	public var D_P(get, never):Bool;

	inline function get_D_P()
		return _dP.check();

	public var S_P(get, never):Bool;

	inline function get_S_P()
		return _sP.check();

	public var W_R(get, never):Bool;

	inline function get_W_R()
		return _wR.check();

	public var A_R(get, never):Bool;

	inline function get_A_R()
		return _aR.check();

	public var D_R(get, never):Bool;

	inline function get_D_R()
		return _dR.check();

	public var S_R(get, never):Bool;

	inline function get_S_R()
		return _sR.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case W:
				func(_w, PRESSED);
				func(_wP, JUST_PRESSED);
				func(_wR, JUST_RELEASED);
			case A:
				func(_a, PRESSED);
				func(_aP, JUST_PRESSED);
				func(_aR, JUST_RELEASED);
			case S:
				func(_s, PRESSED);
				func(_sP, JUST_PRESSED);
				func(_sR, JUST_RELEASED);
			case D:
				func(_d, PRESSED);
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.W, [FlxKey.W]);
				inline bindKeys(Control.A, [FlxKey.A]);
				inline bindKeys(Control.S, [FlxKey.S]);
				inline bindKeys(Control.D, [FlxKey.D]);
				inline bindKeys(Control.ACCEPT, [Z, SPACE, ENTER]);
				inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
				inline bindKeys(Control.PAUSE, [P, ENTER, ESCAPE]);
				inline bindKeys(Control.RESET, [R]);
			case Duo(true):
				inline bindKeys(Control.UP, [FlxKey.W]);
				inline bindKeys(Control.DOWN, [FlxKey.S]);
				inline bindKeys(Control.LEFT, [FlxKey.A]);
				inline bindKeys(Control.RIGHT, [FlxKey.D]);
			...
			case Duo(false):
				...
				inline bindKeys(Control.RIGHT, [FlxKey.RIGHT]);
				inline bindKeys(Control.W, [FlxKey.W]);
				inline bindKeys(Control.A, [FlxKey.S]);
				inline bindKeys(Control.S, [FlxKey.A]);
				inline bindKeys(Control.D, [FlxKey.D]);
